<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['hachimiSys:record:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['hachimiSys:record:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['hachimiSys:record:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['hachimiSys:record:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="recordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="记录类型：0-疫苗；1-体检；2-疾病治疗" align="center" prop="recordType" />
      <el-table-column label="记录内容" align="center" prop="content" />
      <el-table-column label="医生姓名" align="center" prop="doctor" />
      <el-table-column label="医院/机构名称" align="center" prop="hospital" />
      <el-table-column label="记录发生时间" align="center" prop="recordTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.recordTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="录入人ID" align="center" prop="createUserId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="医院/机构名称" prop="hospital">
          <el-input v-model="form.hospital" placeholder="请输入医院/机构名称" />
        </el-form-item>
...
<script>
import { listRecord, getRecord, delRecord, addRecord, updateRecord } from "@/api/hachimiSys/record"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除宠物健康档案信息编号为"' + healthIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('hachimiSys/record/export', {
        ...this.queryParams
