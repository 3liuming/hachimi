 ...
 */
@RestController
@RequestMapping("/hachimiSys/petimage")
public class PetImageController extends BaseController
{
     ...
     * 查询宠物图片信息列表
     */
    @PreAuthorize("@ss.hasPermi('hachimiSys:petimage:list')")
    @GetMapping("/list")
     ...
     * 导出宠物图片信息列表
     */
    @PreAuthorize("@ss.hasPermi('hachimiSys:petimage:export')")
    @Log(title = "宠物图片信息", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    public void export(HttpServletResponse response, PetImage petImage)
    {
        ...
        util.exportExcel(response, list, "宠物图片信息数据");
    }

    /**
     * 获取宠物图片信息详细信息
     */
    @PreAuthorize("@ss.hasPermi('hachimiSys:petimage:query')")
     ...
     * 新增宠物图片信息
     */
    @PreAuthorize("@ss.hasPermi('hachimiSys:petimage:add')")
    @Log(title = "宠物图片信息", businessType = BusinessType.INSERT)
    @PostMapping
     ...
     * 修改宠物图片信息
     */
    @PreAuthorize("@ss.hasPermi('hachimiSys:petimage:edit')")
    @Log(title = "宠物图片信息", businessType = BusinessType.UPDATE)
    @PutMapping
     ...
     * 删除宠物图片信息
     */
    @PreAuthorize("@ss.hasPermi('hachimiSys:petimage:remove')")
    @Log(title = "宠物图片信息", businessType = BusinessType.DELETE)
