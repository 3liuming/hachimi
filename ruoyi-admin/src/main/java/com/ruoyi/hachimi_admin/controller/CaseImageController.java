 ...
 */
@RestController
@RequestMapping("/hachimi_admin/case_image")
public class CaseImageController extends BaseController
{
     ...
     * 查询案例图片列表
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:case_image:list')")
    @GetMapping("/list")
     ...
     * 导出案例图片列表
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:case_image:export')")
    @Log(title = "案例图片", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    public void export(HttpServletResponse response, CaseImage caseImage)
    {
        ...
        util.exportExcel(response, list, "案例图片数据");
    }

    /**
     * 获取案例图片详细信息
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:case_image:query')")
     ...
     * 新增案例图片
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:case_image:add')")
    @Log(title = "案例图片", businessType = BusinessType.INSERT)
    @PostMapping
     ...
     * 修改案例图片
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:case_image:edit')")
    @Log(title = "案例图片", businessType = BusinessType.UPDATE)
    @PutMapping
     ...
     * 删除案例图片
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:case_image:remove')")
    @Log(title = "案例图片", businessType = BusinessType.DELETE)
