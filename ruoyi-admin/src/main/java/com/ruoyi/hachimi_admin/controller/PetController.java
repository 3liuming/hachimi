 ...
 */
@RestController
@RequestMapping("/hachimi_admin/pet")
public class PetController extends BaseController
{
     ...
     * 查询宠物信息列表
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:pet:list')")
    @GetMapping("/list")
     ...
     * 导出宠物信息列表
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:pet:export')")
     ...
     * 获取宠物信息详细信息
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:pet:query')")
     ...
     * 新增宠物信息
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:pet:add')")
     ...
     * 修改宠物信息
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:pet:edit')")
     ...
     * 删除宠物信息
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:pet:remove')")
