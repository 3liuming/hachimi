 ...
 */
@RestController
@RequestMapping("/hachimi_admin/record")
public class PetHealthRecordController extends BaseController
{
     ...
     * 查询宠物健康档案列表
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:record:list')")
    @GetMapping("/list")
     ...
     * 导出宠物健康档案列表
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:record:export')")
    @Log(title = "宠物健康档案", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    public void export(HttpServletResponse response, PetHealthRecord petHealthRecord)
    {
        ...
        util.exportExcel(response, list, "宠物健康档案数据");
    }

    /**
     * 获取宠物健康档案详细信息
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:record:query')")
     ...
     * 新增宠物健康档案
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:record:add')")
    @Log(title = "宠物健康档案", businessType = BusinessType.INSERT)
    @PostMapping
     ...
     * 修改宠物健康档案
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:record:edit')")
    @Log(title = "宠物健康档案", businessType = BusinessType.UPDATE)
    @PutMapping
     ...
     * 删除宠物健康档案
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:record:remove')")
    @Log(title = "宠物健康档案", businessType = BusinessType.DELETE)
