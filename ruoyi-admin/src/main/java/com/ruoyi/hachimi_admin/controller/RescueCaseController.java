 ...
 */
@RestController
@RequestMapping("/hachimi_admin/rescue_case")
public class RescueCaseController extends BaseController
{
     ...
     * 查询救助案例信息列表
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:rescue_case:list')")
    @GetMapping("/list")
     ...
     * 导出救助案例信息列表
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:rescue_case:export')")
     ...
     * 获取救助案例信息详细信息
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:rescue_case:query')")
     ...
     * 新增救助案例信息
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:rescue_case:add')")
     ...
     * 修改救助案例信息
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:rescue_case:edit')")
     ...
     * 删除救助案例信息
     */
    @PreAuthorize("@ss.hasPermi('hachimi_admin:rescue_case:remove')")
